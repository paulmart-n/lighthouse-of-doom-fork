...
object_t items[] =
{
    ...
    },
    {
        ...
        .desc = "A small mirror.",
        .edesc =
            "The mirror doesn't seem to be anything special.\n"
            "But your reflection?  It looks fabulous.\n"
        ,
        .use = use_mirror,
        .use_carried = use_mirror,
        .get_fn = get_mirror,
        .drop_fn = drop_mirror,
    },
    {
        ...
        .edesc =
            "The mirror looks like it was once small and delicate.\n"
            "But now it shows a distorted reflection of yourself,\n"
            "which is oddly unsettling.\n"
        ,
        .use = use_mirror_broken,
        .use_carried = use_mirror_broken,
        .get_fn = get_mirror_broken,
        .drop_fn = drop_mirror_broken,
    },
    {
        .name = "rug",
        .desc = "A small rug.",
    ...
    },
    {
        .name = "painting",
        .desc = "",
        .edesc = "The painting shows a teenager with spiky hair, surrounded by a group of dogs.",
    },
    {
        .name = "telephone",
        .desc = "A telephone, wired to the wall.",
        .use = use_telephone,
    },
    {
        .name = "torch",
        .desc = "A small torch.",
        .use = use_torch,
        .use_carried = use_torch_carried,
        .get_fn = get_torch,
        .drop_fn = drop_torch,
    },
    {
        .name = "torch-lit",
        .desc = "A small torch, which is lit.",
        .get_fn = get_torch_lit,
        .drop_fn = drop_torch_lit,
    },
    {
        .name = "trapdoor-closed",
        .desc = "A closed trapdoor.",
        .edesc =
    ...
    {
        .name = "trapdoor-open",
        .desc = "An open trapdoor.",
        .edesc = "You cannot see anything special about the open trapdoor.\n"
    },
    {
        .name = "",
        .desc = ""
